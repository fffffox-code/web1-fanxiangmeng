...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        // ========== 新增：补充缺失字段 ==========
        orders.setAddress(addressBook.getDetail());          // 配送地址
        orders.setAmount(ordersSubmitDTO.getAmount());       // 合计金额
        orders.setPackAmount(ordersSubmitDTO.getPackAmount()); // 打包费
        orders.setPayMethod(ordersSubmitDTO.getPayMethod());   // 支付方式
        orders.setRemark(ordersSubmitDTO.getRemark());         // 备注
